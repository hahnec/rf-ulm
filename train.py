...
def train_model(
    ...
    # mSPCN Gaussian
    g_len = 5+cfg.upscale_factor//2*2
    psf_heatmap = torch.from_numpy(matlab_style_gauss2D(shape=(g_len,g_len), sigma=cfg.upscale_factor/4 if cfg.input_type == 'iq' else cfg.upscale_factor/2))
