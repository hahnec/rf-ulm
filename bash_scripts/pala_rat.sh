...
python3 ./predict.py model=${model} model_file=${model_file} nms_threshold=${threshold} batch_size=1 pow_law_opt=True data_dir=/storage/workspaces/artorg_aimi/ws_00000/chris/Rat18_2D_InVivoBrain/ logging=pala_rat
